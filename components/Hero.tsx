    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-6">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 leading-none">
          Páginas web y automatizaciones<br />
          para negocios de servicios<span className="text-accent">.</span>
        </h1>

        <p className="text-white/50 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
          Te ayudamos a verte más profesional, captar más clientes y ordenar tu seguimiento — con soluciones simples y bien hechas.
        </p>
